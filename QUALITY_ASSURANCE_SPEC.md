# Quality Assurance Specification - Kiro JavaParser Onboarding
...
```yaml
anti_pattern:
  name: "Bypass Metamodel API"
  description: "Using raw reflection instead of metamodel methods"
  why_bad: "Violates project architecture abstractions"
  evidence: ["PR #5057 feedback", "Multiple maintainer comments"]
  correct_approach: "Use node.isInstanceOfMetaModel() instead"
...
coverage_measurements:
  ...
  subsystem_coverage: "100% major JavaParser components covered"
...
1. **Architecture Patterns** - Metamodel usage, generator development
